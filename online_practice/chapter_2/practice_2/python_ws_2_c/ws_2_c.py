...
first_data = {
    '제목': data['results']['properties']['제목']['title']['text']['content'],
    '일차': int(data['results']['properties']['일차']['number']),
    '단계': data['results']['properties']['단계']['select']['name'] + '단계',
    '과목': data['results']['properties']['과목']['multi_select']['name']
}
