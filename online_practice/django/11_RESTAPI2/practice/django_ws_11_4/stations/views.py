...
from .serializers import LocationSerializer, StationListSerializer, StationSerializer, CarSerializer
...
@api_view(['PUT'])
def car_detail(requset, car_pk):
    car = Car.objects.get(pk=car_pk)
    serializer = CarSerializer(car, data=requset.data, partial=True)
    if serializer.is_valid(raise_exception=True):
        serializer.save()
